...
export const EMAIL_TEMPLATES = {
  ...
  BILLING_SUCCESS: {
    ...
    defaultData: {
      ...
      DOWNLOAD_INVOICE_URL: process.env.FRONTEND_URL + '/billing/invoices',
    },
  },
  ...
  BILLING_FAILED: {
    ...
    defaultData: {
      UPDATE_PAYMENT_URL: process.env.FRONTEND_URL + '/billing/payment-methods',
      RETRY_PAYMENT_URL: process.env.FRONTEND_URL + '/billing/retry-payment',
      ATTEMPT_DATE: new Date().toISOString(),
      GRACE_PERIOD_END: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toLocaleDateString(),
    },
  },

  SUBSCRIPTION_RENEWAL: {
    templateName: 'billing-subscription-expiring',
    ...
    defaultData: {
      ...
      UPGRADE_URL: process.env.FRONTEND_URL + '/billing/upgrade',
    },
  },
